use ratatui::{Frame, layout::{Rect, Layout, Direction, Constraint}, widgets::{Block, Paragraph}};
...
impl MergeVisualizer {
    ...
    pub fn render(&self, frame: &mut Frame, area: Rect) {
        let cols = Layout::default().direction(Direction::Horizontal).constraints([Constraint::Length(24), Constraint::Percentage(38), Constraint::Percentage(38)]).split(area);
